...
@Component({
  selector: 'app-crudsertors',
  templateUrl: './crudsertors.component.html',
  styleUrl: './crudsertors.component.css'
})
export class CrudsertorsComponent {
  showadd!:boolean;
  showupdate!:boolean;
